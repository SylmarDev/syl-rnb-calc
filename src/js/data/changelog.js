...
const CHANGELOG = [
    ...
    new ChangelogLine(3, 1, 0, "Added ability toggle to Download, Magma Armor doesn't allow crits, fix Future Sight and Acid Spray being clickable against immune types (Last update we missed a parathenses WHOOPS LOL)"),
];
